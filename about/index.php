...
<div id="team" class="team-area bg-color pt-90 pb-60">
    <div class="container">
        <div class="row">
            <div class="section-heading text-center mb-70">
                <?$APPLICATION->IncludeComponent(
                    ...
                    Array(
                        "AREA_FILE_SHOW" => "page",
                        "AREA_FILE_SUFFIX" => "about_team_title",
                    )
                );?>
                <p>
                    <?$APPLICATION->IncludeComponent(
                        ...
                        Array(
                            "AREA_FILE_SHOW" => "page",
                            "AREA_FILE_SUFFIX" => "about_team_subtitle",
                        )
                    );?>
                </p>
            </div>
        ...
        <?$APPLICATION->IncludeComponent("bitrix:news.list", "team", Array(
            ...
            "IBLOCK_ID" => getIBlockIdByCode('team'),	// Код информационного блока
...
<?$APPLICATION->IncludeComponent("bitrix:news.list", "reviews", Array(
    ...
    "HIDE_LINK_WHEN_NO_DETAIL" => "N",	// Скрывать ссылку, если нет детального описания
    "PARENT_SECTION" => "",	// ID раздела
    "PARENT_SECTION_CODE" => "reviews-on-about-us",	// Код раздела
    "INCLUDE_SUBSECTIONS" => "Y",	// Показывать элементы подразделов раздела
    "STRICT_SECTION_CHECK" => "N",	// Строгая проверка раздела для показа списка
    "DISPLAY_DATE" => "N",	// Выводить дату элемента
    "DISPLAY_NAME" => "N",	// Выводить название элемента
